...
"""
 ...
 Description : 对 http://life.main.com/xingming.asp 地址的姓名测试表单进行自动提交参数，获取结果页面中的分数结果。
"""
...
def process(output_fpath):
    ...
    fout_sorted.write("姓名\t八字评分\t五格评分\t总分\n")
